<?php
if( ! class_exists('Hongo_Set_attribute_taxonomies' ) ) {
  	class Hongo_Set_attribute_taxonomies {
	...
	$Hongo_Set_attribute_taxonomies = new Hongo_Set_attribute_taxonomies();
