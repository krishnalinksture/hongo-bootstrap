 ...
 *
 * This template can be overridden by copying it to yourtheme/hongo/quick-view/compare-product.php.
 *
 * @package Hongo
 * @version 1.0.0
 */
...
global $product;
echo apply_filters( 'hongo_addons_quick_view_product_compare_link',
