 ...
 *
 * This template can be overridden by copying it to yourtheme/hongo/quick-view/product-image.php.
 *
 * @package Hongo
 * @version 1.0.0
 */
...
global $post, $product, $hongo_slider_script;
...
echo '<div class="'.esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ).'" data-columns="'.esc_attr( $columns ).'" style="opacity: 0; transition: opacity .25s ease-in-out;">';
    ...
    do_action( 'hongo_product_gallery_before' ); 
			...
			echo '<figure class="woocommerce-product-gallery__wrapper quick-view-images swiper-container">';
				...
				echo '<div class="swiper-wrapper">';
					...
					if ( has_post_thumbnail() ) {
	                    ...
	                    $html .= sprintf( '<img src="%s" alt="%s" class="wp-post-image" />', esc_url( wc_placeholder_img_src() ), esc_html__( 'Awaiting product image', 'hongo-addons' ) );
	                    $html .= '</div>';
	                }
    ...
    do_action( 'hongo_product_gallery_after' );
