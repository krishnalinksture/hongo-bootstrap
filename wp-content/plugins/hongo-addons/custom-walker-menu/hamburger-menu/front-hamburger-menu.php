...
/**
 * Navigation Menu API: Hongo_Hamburger_Menu_Walker class
 *
 */
...
if( ! class_exists( 'Hongo_Hamburger_Menu_Walker' ) ) {

    class Hongo_Hamburger_Menu_Walker extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            $link_class = apply_filters( 'hongo_hamburger_link_css_class', $link_class, $depth );
            ...
            if( ( $depth == 0 || $depth == 1 || $depth == 2 ) && $args->walker->has_children ) {
                $item_output .= '<span class="menu-dropdown-toggle"></span>';
            }
