...
if( class_exists('WP_Customize_Control') ) {
	...
	if( ! class_exists( 'Hongo_Alpha_Color_Control' ) ) {

		class Hongo_Alpha_Color_Control extends WP_Customize_Control {
			/**
			...
			public function enqueue() {
				...
				wp_enqueue_script(
					'alpha-color-picker',
					HONGO_ADDONS_ROOT_DIR.'/assets/js/admin/alpha-color-picker.js',
				...
				wp_enqueue_style(
					'alpha-color-picker',
					HONGO_ADDONS_ROOT_DIR.'/assets/css/admin/alpha-color-picker.css',
