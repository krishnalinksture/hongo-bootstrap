...
hongo_meta_box_dropdown('hongo_page_layout_setting_single',
...
hongo_meta_box_dropdown_sidebar('hongo_page_left_sidebar_single',
				esc_html__('Left sidebar', 'hongo-addons'),
				$hongo_sidebar_array,
				esc_html__('Select sidebar to display in left column of page', 'hongo-addons'),
				array( 'element' => 'hongo_page_layout_setting_single', 'value' => array('default', 'hongo_layout_left_sidebar', 'hongo_layout_both_sidebar'))
			);
hongo_meta_box_dropdown_sidebar(	'hongo_page_right_sidebar_single',
				esc_html__('Right sidebar', 'hongo-addons'),
				$hongo_sidebar_array,
				esc_html__('Select sidebar to display in right column of page', 'hongo-addons'),
				array( 'element' => 'hongo_page_layout_setting_single', 'value' => array('default', 'hongo_layout_right_sidebar', 'hongo_layout_both_sidebar'))
			);
hongo_meta_box_dropdown(	'hongo_page_container_style_single',
...
hongo_meta_box_text( 'hongo_page_container_fluid_with_padding_single', 
				esc_html__('Full width padding', 'hongo-addons'),
				'',
				'',
				array( 'element' => 'hongo_page_container_style_single', 'value' => array( 'default', 'container-fluid-with-padding' ) )
			);
