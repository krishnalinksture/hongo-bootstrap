...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr class="alt-font">
				<th class="product-name"><?php esc_html_e( 'Product', 'hongo' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'hongo' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'hongo' ); ?></th>
			</tr>
		</thead>
		<tbody>
		...
		<tfoot>
			<?php if ( $totals ) : ?>
				<?php foreach ( $totals as $total ) : ?>
					<tr class="alt-font">
						<th scope="row" colspan="2"><?php echo isset( $total['label'] ) ? $total['label'] : ''; ?></th><?php // @codingStandardsIgnoreLine ?>
						<td class="product-total"><?php echo isset( $total['value'] ) ? $total['value'] : ''; ?></td><?php // @codingStandardsIgnoreLine ?>
					</tr>
				<?php endforeach; ?>
			<?php endif; ?>
		</tfoot>
