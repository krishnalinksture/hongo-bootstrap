    ...
    <div class="woocommerce-form-login-toggle">
        ...
        wc_print_notice(
            apply_filters(
                ...
                '<i class="ti-user base-color"></i><span class="alt-font">'.esc_html__( 'Returning customer?', 'hongo' ) ) . ' </span><a href="#" class="showlogin alt-font">' . esc_html__( 'Click here to login', 'hongo' ) . '</a>',
            'notice'
        );
        ?>
    </div>
...
if ( $registration_at_checkout || $login_reminder_at_checkout ) :
	...
	woocommerce_login_form(
		array(
			'message'  => esc_html__( 'If you have shopped with us before, please enter your details below. If you are a new customer, please proceed to the Billing section.', 'hongo' ),
