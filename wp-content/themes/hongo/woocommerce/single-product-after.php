...
switch ($hongo_single_product_layout_setting) {
	...
	case 'hongo_layout_left_sidebar':
		?>
			...
			<div id="secondary" class="sidebar order-lg-1 hongo-product-sidebar hongo-woocommerce-sidebar hongo-product-common-sidebar-left<?php echo esc_attr( $hongo_product_sidebar_class ); ?>" itemtype="http://schema.org/WPSideBar" itemscope="itemscope" role="complementary">
