...
get_header( 'shop' );
	...
	$top_space_class = ( get_theme_mod( 'hongo_product_archive_page_enable_top_space', '0' ) == '1' ) ? ' top-space' : '';
?>
	<section class="hongo-shop-archive hongo-main-content-wrap<?php echo $top_space_class; ?>">
		<div class="<?php echo esc_attr( $hongo_product_archive_container_style ); ?>">
			<div class="row">
				<?php
				/**
