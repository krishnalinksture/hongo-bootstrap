...
$hongo_product_sidebar_class			= ( $hongo_product_archive_container_style == 'container' ) ? ' col-xl-9 col-lg-12 col-md-12' :  ' col-xl-10 col-lg-12 col-md-12';
$hongo_product_both_sidebar_class		= ( $hongo_product_archive_container_style == 'container' ) ? ' col-xl-6 col-lg-12 col-md-12' :  ' col-xl-8 col-lg-12 col-md-12';
...
switch( $hongo_product_archive_layout_setting ) {
	case 'hongo_layout_no_sidebar':
		?>
			<div class="col-md-12 col-12 hongo-content-full-part hongo-shop-content-part">
		<?php
			do_action( 'hongo_shop_content_part_start' );
		break;
	case 'hongo_layout_left_sidebar':
		?>
			<div class="col-12 pull-right hongo-content-right-part hongo-shop-content-part<?php echo esc_attr( $hongo_product_sidebar_class ); ?>">
		<?php
			do_action( 'hongo_shop_content_part_start' );
		break;
	...
	case 'hongo_layout_both_sidebar':
		?>
			<div class="both-sidebar-wrap">
				<div class="col-12 both-content-center post-center hongo-content-center-part hongo-shop-content-part<?php echo esc_attr( $hongo_product_both_sidebar_class ); ?>">
		<?php
				do_action( 'hongo_shop_content_part_start' );
		break;
}
