 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/content-single-product/single-product-left-content.php.
 *
 * @package Hongo
 * @version 1.0.0
 */
...
?>
	...
	<?php
		 ...
		 * @hooked woocommerce_upsell_display - 80
		 * @hooked woocommerce_output_related_products - 90
