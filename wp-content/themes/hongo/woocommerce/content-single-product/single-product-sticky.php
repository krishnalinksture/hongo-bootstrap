 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/content-single-product/single-product-sticky.php.
 *
 * @package Hongo
 * @version 1.0.0
 */
...
?>
	<div class="hongo-sticky-content-images-wrap" data-sticky_parent>
		<?php
			 ...
			 *
			 * @hooked hongo_single_product_sticky_thumbnails - 10	 
