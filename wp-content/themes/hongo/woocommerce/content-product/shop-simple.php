 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/content-product/shop-simple.php.
 *
 * @package Hongo
 * @version 1.0.0
 */
...
?>
	...
	<div class="product-title-price-wrap">
		...
		<?php
			 ...
			 *
			 * @hooked hongo_price_button_wrap_start - 3
			 * @hooked woocommerce_template_loop_price - 5
			 * @hooked woocommerce_template_loop_rating - 6
			 * @hooked woocommerce_template_loop_add_to_cart - 7			 
			 * @hooked hongo_price_button_wrap_end - 9		 
			 */
