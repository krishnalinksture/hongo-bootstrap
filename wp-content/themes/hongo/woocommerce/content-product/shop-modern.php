 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/content-product/shop-modern.php.
 *
 * @package Hongo
 * @version 1.0.0
 */
...
?>
	<div class="product-thumb-wrap">
		...
		<div class="product-bottom-wrap">
			<?php
				/**
				 * hongo_shop_modern_loop_add_to_cart hook.
				 *
				 * @hooked woocommerce_template_loop_add_to_cart - 5
				 */
				do_action( 'hongo_shop_modern_loop_add_to_cart' );
			?>
		</div>
		<?php
			/**
