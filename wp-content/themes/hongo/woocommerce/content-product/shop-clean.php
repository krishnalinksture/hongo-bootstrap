 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/content-product/shop-clean.php.
 *
 * @package Hongo
 * @version 1.0.0
 */
	...
	<div class="product-thumb-wrap">
		<div class="product-thumb-inner">
			<?php
				 ...
				 * @hooked hongo_template_loop_product_overlay - 90
		...
		<div class="product-title-category-wrap">
			<?php
				/**
				 * hongo_before_shop_clean_loop_item_title hook.
				 *
				 * @hooked woocommerce_template_loop_rating - 10
				 
				 */
				do_action( 'hongo_before_shop_clean_loop_item_title' );
			?>
			...
			<?php
				/**
				 * hongo_after_shop_clean_loop_item_title hook.
				 *
				 */
				do_action( 'hongo_after_shop_clean_loop_item_title' );
			?>
