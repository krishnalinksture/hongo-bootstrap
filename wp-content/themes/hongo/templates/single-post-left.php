...
if ( ! defined( 'ABSPATH' ) ) { exit; }
	...
	switch( $hongo_single_post_layout_setting ) {
		case 'hongo_layout_left_sidebar':
			?>
				<div class="col-lg-9 col-md-12 col-12 order-lg-2 order-1 hongo-layout-left-sidebar pull-right no-padding-right hongo-content-right-part">
			<?php
			break;
		case 'hongo_layout_right_sidebar':
			?>
				<div class="col-lg-9 col-md-12 col-12 hongo-layout-right-sidebar no-padding-left hongo-content-left-part">
			<?php
			break;
		case 'hongo_layout_both_sidebar':
			?>
				<div class="both-sidebar-wrap">
			        <div class="col-lg-6 col-md-12 col-12 hongo-layout-both-sidebar no-padding-lr hongo-content-center-part">
	        <?php
	    	break;
	}
