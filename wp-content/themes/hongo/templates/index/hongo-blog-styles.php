		...
		if( ! is_sticky() ) {
			...
			switch ( $blog_style ) {
				...
				case 'blog-standard':
					...
					echo  '<div class="blog-single-post blog-post col-lg-12 col-md-12 col-12 blog-style9-' . $blog_style . esc_attr( $hongo_animation_index ) . '"' . $hongo_animation_delay_attr . '>'; // @codingStandardsIgnoreLine
						$post_format = get_post_format( get_the_ID() );
					?>
						<div <?php echo sprintf( '%s', $hongo_post_classes ); ?>>
