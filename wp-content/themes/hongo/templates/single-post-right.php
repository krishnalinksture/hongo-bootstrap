	...
	switch ( $hongo_single_post_layout_setting ) {
		case 'hongo_layout_left_sidebar':
			?>
				...
				<div id="secondary" class="col-lg-3 col-md-12 col-12 sidebar order-md-1 hongo-post-sidebar hongo-blog-sidebar<?php echo esc_attr( $hongo_post_sidebar_class ); ?>" itemtype="http://schema.org/WPSideBar" itemscope="itemscope" role="complementary">
					<?php
