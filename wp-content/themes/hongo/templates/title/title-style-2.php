 ...
 * Title section
 *
 * This template can be overridden by copying it to yourchildtheme/templates/title/title-style-2.php
 */
	...
	?>
		<div class="<?php echo esc_attr( $container_style ); ?>">
			<div class="row align-items-stretch">
				...
				<div class="col-xl-7 col-lg-6 col-md-12 col-12 display-table page-title-small pull-right sm-margin-15px-top">
					<?php if( $hongo_title != '' || ( $hongo_enable_subtitle != '0' && $hongo_title_subtitle ) || $hongo_enable_title_heading == '1' ) { ?>
