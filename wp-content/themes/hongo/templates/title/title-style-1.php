 ...
 * Title section
 *
 * This template can be overridden by copying it to yourchildtheme/templates/title/title-style-1.php
 */
	...
	?>
		<div class="<?php echo esc_attr( $container_style ); ?>">
			<div class="row equalize sm-equalize-auto">
				...
				<div class="col-xl-5 col-lg-6 col-md-12 col-12 display-table text-right sm-text-center sm-margin-15px-top">
