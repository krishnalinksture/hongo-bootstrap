...
if( hongo_is_woocommerce_activated() ) {
    ...
    add_action( 'woocommerce_single_product_summary', 'hongo_product_single_main_summary_structure_carousel_start', 1 );
    if( ! function_exists( 'hongo_product_single_main_summary_structure_carousel_start' ) ) {
        function hongo_product_single_main_summary_structure_carousel_start() {
            echo '<div class="hongo-summary-left-content">';
                echo '<div class="hongo-summary-left-wrap">';
        }
    }
    ...
    add_action( 'woocommerce_single_product_summary', 'hongo_product_single_main_summary_structure_carousel_middle', 29 );
    if( ! function_exists ( 'hongo_product_single_main_summary_structure_carousel_middle' ) ) {
        function hongo_product_single_main_summary_structure_carousel_middle(){
                    echo '</div>';
                echo '</div>';
                echo '<div class="hongo-summary-right-content">';
                    echo '<div class="hongo-summary-right-wrap">';
        }
    }

    /* To Product Main Structure summary End */
    add_action( 'woocommerce_single_product_summary', 'hongo_product_single_main_summary_structure_carousel_end', 55 );
    if( ! function_exists ( 'hongo_product_single_main_summary_structure_carousel_end' ) ) {
        function hongo_product_single_main_summary_structure_carousel_end(){
                echo '</div>';
            echo '</div>';
        }
    }

    // Dislay empty featured product message
    add_action( 'woocommerce_shortcode_featured_products_loop_no_results', 'hongo_featured_products_loop_no_results'  );
    ...
    add_action( 'woocommerce_after_single_product_summary', 'hongo_single_product_tab_layout3_wrap_start', 5 );
    if( ! function_exists ( 'hongo_single_product_tab_layout3_wrap_start' ) ) {
        function hongo_single_product_tab_layout3_wrap_start() {
            echo '<div class="hongo-single-product-tab-content-carousel">';
        }
    }

    /* To add Tabbing Structure End */
    add_action( 'woocommerce_after_single_product_summary', 'hongo_single_product_tab_layout3_wrap_end', 12 );
    if( ! function_exists ( 'hongo_single_product_tab_layout3_wrap_end' ) ) {
        function hongo_single_product_tab_layout3_wrap_end() {
            echo '</div>';
        }
    }
