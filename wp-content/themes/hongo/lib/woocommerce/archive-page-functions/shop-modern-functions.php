...
if( hongo_is_woocommerce_activated() ) {
    ...
    if( ! function_exists( 'hongo_before_shop_loop_shop_modern_callback' ) ) {
        function hongo_before_shop_loop_shop_modern_callback() {
    ...
    add_action( 'hongo_before_shop_loop_shop-modern', 'hongo_before_shop_loop_shop_modern_callback' );

    if( ! function_exists( 'hongo_after_shop_loop_shop_modern_callback' ) ) {
        function hongo_after_shop_loop_shop_modern_callback() {
    ...
    add_action( 'hongo_after_shop_loop_shop-modern', 'hongo_after_shop_loop_shop_modern_callback' );
}
