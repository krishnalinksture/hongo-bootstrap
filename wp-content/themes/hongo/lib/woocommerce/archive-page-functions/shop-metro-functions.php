...
if( hongo_is_woocommerce_activated() ) {
    ...
    if( ! function_exists( 'hongo_before_shop_loop_shop_metro_callback' ) ) {
        function hongo_before_shop_loop_shop_metro_callback() {
            ...
            if( $hongo_get_product_archive_list_overlay == 1 ) {
                add_action( 'woocommerce_before_shop_loop_item_title', 'hongo_template_loop_overlay', 5 );
            }
    ...
    add_action( 'hongo_before_shop_loop_shop-metro', 'hongo_before_shop_loop_shop_metro_callback' );

    if( ! function_exists( 'hongo_after_shop_loop_shop_metro_callback' ) ) {
        function hongo_after_shop_loop_shop_metro_callback() {
            ...
            $hongo_get_product_archive_list_overlay = hongo_get_product_archive_list_overlay();
            if( $hongo_get_product_archive_list_overlay == 1 ) {
                remove_action( 'woocommerce_before_shop_loop_item_title', 'hongo_template_loop_overlay', 5 );
            }
            ...
            $hongo_product_archive_enable_add_to_cart = hongo_get_product_archive_enable_add_to_cart();
            if( $hongo_product_archive_enable_add_to_cart == 1 ) {
                remove_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_add_to_cart', 5 );
                remove_action( 'hongo_shop_loop_button', 'woocommerce_template_loop_add_to_cart', 25 );
            }
        }
    }
    add_action( 'hongo_after_shop_loop_shop-metro', 'hongo_after_shop_loop_shop_metro_callback' );
}
