...
if( hongo_is_woocommerce_activated() ) {
    ...
    if( ! function_exists( 'hongo_before_shop_loop_shop_boxed_callback' ) ) {
        function hongo_before_shop_loop_shop_boxed_callback() {
            ...
            if( $hongo_get_product_archive_list_overlay == 1 ) {
                ...
                add_action( 'woocommerce_before_subcategory_title', 'hongo_template_loop_product_overlay', 90 );
            }
    ...
    add_action( 'hongo_before_shop_loop_shop-boxed', 'hongo_before_shop_loop_shop_boxed_callback' );

    if( ! function_exists( 'hongo_after_shop_loop_shop_boxed_callback' ) ) {
        function hongo_after_shop_loop_shop_boxed_callback() {
            ...
            if( $hongo_get_product_archive_list_overlay == 1 ) {
                ...
                remove_action( 'woocommerce_before_subcategory_title', 'hongo_template_loop_product_overlay', 90 );
            }
    ...
    add_action( 'hongo_after_shop_loop_shop-boxed', 'hongo_after_shop_loop_shop_boxed_callback' );
}
