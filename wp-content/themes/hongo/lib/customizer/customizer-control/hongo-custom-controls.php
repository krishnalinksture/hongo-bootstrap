                            ...
                            <?php
                                foreach ( $hongo_srcset as $value => $label ) {
                                    echo '<option value="' . esc_attr( $label ) . '"' . selected( $this->value(), $value, false ) . '>';
                                        ...
                                        $width = ( isset( $hongo_srcset_image_data['width'] ) && $hongo_srcset_image_data['width'] != 0 ) ? $hongo_srcset_image_data['width'].'px' : esc_html__( 'Auto', 'hongo' );
                                        $height = ( isset( $hongo_srcset_image_data['height'] ) && $hongo_srcset_image_data['height'] != 0 ) ? $hongo_srcset_image_data['height'].'px' : esc_html__( 'Auto', 'hongo' );
                                        if ( $label == 'full' ) {
        ...
        class Hongo_Customize_Switch_Control extends WP_Customize_Control {
            ...
            public function render_content() {
                ...
                foreach ( $this->choices as $value => $label ) :
                    ...
                    ?>
                    <li class="<?php echo esc_attr( $hongo_switch_class ) . esc_attr( $active_class ); ?>">
                    <label>
